...
var slideshow = (function(window, undefined) {
   ...
   */
  var slides = [
    'images/prism-slider/nature-a.jpg',
    'images/prism-slider/nature-b.jpg',
    'images/prism-slider/nature-c.jpg',
    'images/prism-slider/nature-d.jpg'
  ];
  ...
  var masks = [
    {
      source: 'images/masks/cube-a.svg',
      effects: {
        flip: 'Y',
        rotate: 167 // degrees
      }
    ...
    {
      source: 'images/masks/cube-b.svg',
      effects: {
        flip: 'X',
        rotate: 90 // degrees
      }
    ...
    {
      source: 'images/masks/cube-c.svg',
      effects: {
        flip: false,
        rotate: 13 // degrees
      }
