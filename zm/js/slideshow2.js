...
var slideshow = (function(window, undefined) {
   ...
   */
  var slides = [
    'images/prism-slider/graffiti-a.jpg',
    'images/prism-slider/graffiti-b.jpg',
    'images/prism-slider/graffiti-c.jpg'
  ];
  ...
  var masks = [
    {
      source: 'images/masks/triangle-a.svg',
      effects: {
        flip: 'Y',
        rotate: 167 // degrees
      }
    ...
    {
      source: 'images/masks/triangle-b.svg',
      effects: {
        flip: 'X',
        rotate: 90 // degrees
      }
    ...
    {
      source: 'images/masks/triangle-c.svg',
      effects: {
        flip: 'Y',
        rotate: 25 // degrees
      }
