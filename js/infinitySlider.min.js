...
!1;if(a.attr("data-effectinback")){var c=$.trim(a.attr("data-effectinback")).split(" "),t=c.length;if(0==t)b=b+"There is not any effectInBack on the slide number: "+d+"\n";else if(-1==a.attr("data-effectinback").indexOf("none"))for(var g=0;g<t;g++){var l=c[g],h="InBack",m=!1,p=!1;g==t-1&&(m=!0);ma(l,h,m,p)}}else f=!0;a.attr("data-effectintimeback")||0==a.attr("data-effectintimeback")?(g=a.attr("data-effectintimeback"),$.isNumeric(g)?(c=parseInt(g),0>c?b=b+"The effectInTimeBack("+g+") on the slide number: "+
